...
url = (
    "jdbc:mysql://ec2-3-35-104-222.ap-northeast-2.compute.amazonaws.com:3306/sparkplus"
)
user = "sparkplus"
password = "sparkplus"
...
full_doro_df = RoadnameDataframe(full_doro_df)
doro_to_roadname_df = full_doro_df.add_split("roadname_address")
